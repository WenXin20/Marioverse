...
public class PiranhaPlantEntity extends Monster implements GeoEntity {
    private static final EntityDataAccessor<Byte> DATA_ID_RIDE_FLAGS = SynchedEntityData.defineId(PiranhaPlantEntity.class, EntityDataSerializers.BYTE);
    private static final EntityDataAccessor<Byte> DATA_ID_SCARE_FLAGS = SynchedEntityData.defineId(PiranhaPlantEntity.class, EntityDataSerializers.BYTE);
    private static final EntityDataAccessor<Byte> DATA_ID_SIT_FLAGS = SynchedEntityData.defineId(PiranhaPlantEntity.class, EntityDataSerializers.BYTE);
    private static final EntityDataAccessor<Byte> DATA_ID_SLEEP_FLAGS = SynchedEntityData.defineId(PiranhaPlantEntity.class, EntityDataSerializers.BYTE);
    public static final RawAnimation CONSTANT_BITES_ANIM = RawAnimation.begin().thenPlayAndHold("piranha_plant.constant_bite");
    ...
    public void checkForCollisionsAndWakeUp() {
        ...
        if (!nearbyEntities.isEmpty()) {
            for (Entity collidingEntity : nearbyEntities) {
                if ((!this.isSleeping() && !this.isSitting()) || collidingEntity instanceof PiranhaPlantEntity
