...
public class DamageSourceRegistry {
    public static DamageSource bonked(@Nullable Entity damagedEntity, @Nullable Entity attackingEntity) {
        if (damagedEntity != null && attackingEntity != null) {
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.PLAYER_BONKED), damagedEntity, attackingEntity);
        } else if (attackingEntity != null) {
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.BONKED), null, attackingEntity);
        } else return null;
    }
    ...
    public static DamageSource defeated(@Nullable Entity damagedEntity, @Nullable Entity attackingEntity) {
        if (damagedEntity != null && attackingEntity != null) {
            ...
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.MINI_GOOMBA_DEFEATED), null, attackingEntity);
        } else return null;
    }

    public static DamageSource fireball(@Nullable Entity projectile, @Nullable Entity shooter) {
        if (shooter != null && projectile != null) {
            return new DamageSource(shooter.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.PLAYER_FIREBALL), projectile, shooter);
        } else if (shooter != null) {
            return new DamageSource(shooter.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.FIREBALL), null, shooter);
        } else return null;
    }

    public static DamageSource iceBall(@Nullable Entity projectile, @Nullable Entity shooter) {
        if (shooter != null && projectile != null) {
            return new DamageSource(shooter.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.PLAYER_ICE_BALL), projectile, shooter);
        } else if (shooter != null) {
            return new DamageSource(shooter.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.ICE_BALL), null, shooter);
        } else return null;
    }
    ...
    public static DamageSource iceCubeCrushed(@Nullable Entity damagedEntity, @Nullable Entity attackingEntity) {
        if (attackingEntity != null && damagedEntity != null) {
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.PLAYER_ICE_CUBE_CRUSHED), damagedEntity, attackingEntity);
        } else if (attackingEntity != null) {
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.ICE_CUBE_CRUSHED), null, attackingEntity);
        } else return null;
    }
    ...
    public static DamageSource shrapnel(@Nullable Entity damagedEntity, @Nullable Entity attackingEntity) {
        if (damagedEntity != null && attackingEntity != null) {
            ...
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.SHRAPNEL), null, attackingEntity);
        } else return null;
    }

    public static DamageSource spiked(@Nullable Entity damagedEntity) {
        if (damagedEntity != null) {
            return new DamageSource(damagedEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.SPIKED));
        } else return null;
    }

    public static DamageSource spinningShell(@Nullable Entity damagedEntity, @Nullable Entity attackingEntity) {
        if (damagedEntity != null && attackingEntity != null) {
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.PLAYER_SPINNING_SHELL), damagedEntity, attackingEntity);
        } else if (attackingEntity != null) {
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.SPINNING_SHELL), null, attackingEntity);
        } else return null;
    }

    public static DamageSource stomp(@Nullable Entity entity, @Nullable Entity stomper) {
        if (stomper != null && entity != null) {
            return new DamageSource(stomper.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.PLAYER_STOMP), entity, stomper);
        } else if (stomper != null) {
            return new DamageSource(stomper.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.STOMP), null, stomper);
        } else return null;
    }

    public static DamageSource superStar(@Nullable Entity damagedEntity, @Nullable Entity attackingEntity) {
        if (attackingEntity != null && damagedEntity != null) {
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.PLAYER_SUPER_STAR), damagedEntity, attackingEntity);
        } else if (attackingEntity != null) {
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.SUPER_STAR), null, attackingEntity);
        } else return null;
    }

    public static DamageSource piranhaChomp(@Nullable Entity damagedEntity, @Nullable Entity attackingEntity) {
        if (attackingEntity != null && damagedEntity != null) {
            return new DamageSource(attackingEntity.level().registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypeRegistry.PLAYER_PIRANHA_CHOMP), damagedEntity, attackingEntity);
        } else if (attackingEntity != null) {
