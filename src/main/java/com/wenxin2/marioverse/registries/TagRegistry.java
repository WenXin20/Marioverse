...
public class TagRegistry {
    ...
    public static final TagKey<Block> BRIDGE_STAIR_BLOCKS = blockTags("bridge_stairs");
    ...
    public static final TagKey<DamageType> BYPASSES_MEGA_MUSHROOM = damageTypeTags("bypasses_mega_mushroom");
    ...
    public static final TagKey<EntityType<?>> CANNOT_CHANGE_MAX_HEALTH = entityTypeTags("cannot_change_max_health");
    ...
    public static final TagKey<EntityType<?>> DAMAGE_REMOVES_COSTUME = entityTypeTags("damage_removes_costume");
    ...
    public static final TagKey<EntityType<?>> POWER_UP_APPLIES_COSTUME = entityTypeTags("power_up_applies_costume");
