...
public class DataAttachmentRegistry {
    ...
    public static final Supplier<AttachmentType<Boolean>> IS_CHARGING = Marioverse.ATTACHMENT_TYPES
            .register("is_charging", () -> AttachmentType.builder(() -> false).serialize(Codec.BOOL)
                    .sync(StreamCodec.of(FriendlyByteBuf::writeBoolean, FriendlyByteBuf::readBoolean)).build());
    public static final Supplier<AttachmentType<Boolean>> IS_EATING = Marioverse.ATTACHMENT_TYPES
            .register("is_eating", () -> AttachmentType.builder(() -> false).serialize(Codec.BOOL)
                    .sync(StreamCodec.of(FriendlyByteBuf::writeBoolean, FriendlyByteBuf::readBoolean)).build());
    ...
    public static final Supplier<AttachmentType<Integer>> AIRBORNE_DURATION = Marioverse.ATTACHMENT_TYPES
            .register("airborne_duration", () -> AttachmentType.builder(() -> 0).serialize(Codec.INT).build());
    ...
    public static final Supplier<AttachmentType<Integer>> MEGA_MUSHROOM_DURATION = Marioverse.ATTACHMENT_TYPES
            .register("mega_mushroom_duration", () -> AttachmentType.builder(() -> 0).serialize(Codec.INT)
                    .sync(StreamCodec.of(FriendlyByteBuf::writeInt, FriendlyByteBuf::readInt)).build());
    public static final Supplier<AttachmentType<Integer>> MENU_TYPE = Marioverse.ATTACHMENT_TYPES
            .register("menu_type", () -> AttachmentType.builder(() -> 0).serialize(Codec.INT)
                    .sync(StreamCodec.of(FriendlyByteBuf::writeInt, FriendlyByteBuf::readInt)).build());
    ...
    public static final Supplier<AttachmentType<Integer>> RIDE_VEHICLE_COUNTDOWN = Marioverse.ATTACHMENT_TYPES
            .register("ride_vehicle_countdown", () -> AttachmentType.builder(() -> 0).serialize(Codec.INT)
                    .sync(StreamCodec.of(FriendlyByteBuf::writeInt, FriendlyByteBuf::readInt)).build());
    public static final Supplier<AttachmentType<UUID>> OWNER_UUID = Marioverse.ATTACHMENT_TYPES
            .register("owner_uuid", () -> AttachmentType.<UUID>builder(() -> null).serialize(UUIDUtil.CODEC)
