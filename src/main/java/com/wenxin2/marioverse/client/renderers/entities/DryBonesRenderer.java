...
//                poseStack.translate(0.0F, 0.1F, 0.75F);
        ...
        this.addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            ...
            protected ItemStack getStackForBone(GeoBone bone, DryBonesEntity animatable) {
                return switch (bone.getName()) {
                    ...
                    case LEFT_ARM -> animatable.isLeftHanded() ?
                            DryBonesRenderer.this.mainHandItem : DryBonesRenderer.this.offhandItem;
                    case RIGHT_ARM -> animatable.isLeftHanded() ?
                            DryBonesRenderer.this.offhandItem : DryBonesRenderer.this.mainHandItem;
                    default -> null;
                };
            }
            ...
            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone, ItemStack stack, DryBonesEntity animatable,
