...
import com.wenxin2.marioverse.client.models.entities.EepCheepModel;
...
public class EepCheepRenderer extends GeoEntityRenderer<EepCheepEntity> {
    ...
    public EepCheepRenderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new ItemArmorGeoLayer<>(this) {
            @Nullable
            @Override
            protected ItemStack getArmorItemForBone(GeoBone bone, EepCheepEntity animatable) {
            ...
            @NotNull
            @Override
            protected EquipmentSlot getEquipmentSlotForBone(GeoBone bone, ItemStack stack, EepCheepEntity animatable) {
                return switch (bone.getName()) {
            ...
            @NotNull
            @Override
            protected ModelPart getModelPartForBone(GeoBone bone, EquipmentSlot slot, ItemStack stack, EepCheepEntity animatable, HumanoidModel<?> baseModel) {
                return switch (bone.getName()) {
        ...
        this.addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            @Nullable
            @Override
            protected ItemStack getStackForBone(GeoBone bone, EepCheepEntity animatable) {
                return switch (bone.getName()) {
                    case HELMET -> {
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, EepCheepEntity animatable) {
                return switch (bone.getName()) {
            ...
            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone, ItemStack stack, EepCheepEntity animatable,
    ...
    @Override
    public void scaleModelForRender(float widthScale, float heightScale, PoseStack poseStack, EepCheepEntity animatable,
