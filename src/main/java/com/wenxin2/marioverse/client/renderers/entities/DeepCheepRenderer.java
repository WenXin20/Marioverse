...
import com.wenxin2.marioverse.client.models.entities.DeepCheepModel;
...
public class DeepCheepRenderer extends GeoEntityRenderer<DeepCheepEntity> {
    ...
    public DeepCheepRenderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new ItemArmorGeoLayer<>(this) {
            @Nullable
            @Override
            protected ItemStack getArmorItemForBone(GeoBone bone, DeepCheepEntity animatable) {
            ...
            @NotNull
            @Override
            protected EquipmentSlot getEquipmentSlotForBone(GeoBone bone, ItemStack stack, DeepCheepEntity animatable) {
                return switch (bone.getName()) {
            ...
            @NotNull
            @Override
            protected ModelPart getModelPartForBone(GeoBone bone, EquipmentSlot slot, ItemStack stack, DeepCheepEntity animatable, HumanoidModel<?> baseModel) {
                return switch (bone.getName()) {
        ...
        this.addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            @Nullable
            @Override
            protected ItemStack getStackForBone(GeoBone bone, DeepCheepEntity animatable) {
                return switch (bone.getName()) {
                    case HELMET -> {
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, DeepCheepEntity animatable) {
                return switch (bone.getName()) {
            ...
            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone, ItemStack stack, DeepCheepEntity animatable,
    ...
    @Override
    public void scaleModelForRender(float widthScale, float heightScale, PoseStack poseStack, DeepCheepEntity animatable,
