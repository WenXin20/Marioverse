...
public class MiniGoombaRenderer extends GeoEntityRenderer<MiniGoombaEntity> {
    ...
    public MiniGoombaRenderer(EntityRendererProvider.Context renderManager) {
        ...
        addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            ...
            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone, ItemStack stack, MiniGoombaEntity animatable, MultiBufferSource bufferSource, float partialTick, int packedLight, int packedOverlay) {
