...
public class MarioIceCostumeRenderer extends GeoArmorRenderer<MarioIceCostumeItem> {
    public MarioIceCostumeRenderer() {
        super(new DefaultedItemGeoModel<>(ResourceLocation
                .fromNamespaceAndPath(Marioverse.MOD_ID, "costume/mario_ice_costume")));
    }
