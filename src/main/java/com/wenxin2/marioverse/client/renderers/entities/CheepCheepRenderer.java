...
public class CheepCheepRenderer extends GeoEntityRenderer<CheepCheepEntity> {
    ...
    public CheepCheepRenderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addRenderLayer(new ItemArmorGeoLayer<>(this) {
            @Nullable
            @Override
            protected ItemStack getArmorItemForBone(GeoBone bone, CheepCheepEntity animatable) {
            ...
            @NotNull
            @Override
            protected EquipmentSlot getEquipmentSlotForBone(GeoBone bone, ItemStack stack, CheepCheepEntity animatable) {
                return switch (bone.getName()) {
            ...
            @NotNull
            @Override
            protected ModelPart getModelPartForBone(GeoBone bone, EquipmentSlot slot, ItemStack stack, CheepCheepEntity animatable, HumanoidModel<?> baseModel) {
                return switch (bone.getName()) {
        ...
        this.addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            @Nullable
            @Override
            protected ItemStack getStackForBone(GeoBone bone, CheepCheepEntity animatable) {
                return switch (bone.getName()) {
                    case HELMET -> {
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, CheepCheepEntity animatable) {
                return switch (bone.getName()) {
            ...
            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone, ItemStack stack, CheepCheepEntity animatable,
