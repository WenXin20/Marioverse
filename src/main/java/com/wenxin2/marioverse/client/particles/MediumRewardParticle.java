...
public class MediumRewardParticle extends SuspendedTownParticle.HappyVillagerProvider {

    public MediumRewardParticle(SpriteSet spriteSet) {
        super(spriteSet);
    }
