...
public class CharacterSmithingTemplateItem extends SmithingTemplateItem {
    ...
    private static final Component MARIO_UPGRADE = Component.translatable(
    ...
    private static final Component MARIO_UPGRADE_INGREDIENTS = Component.translatable(
            Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Marioverse.MOD_ID, "smithing_template.mario_costume.ingredients")))
            .withStyle(DESCRIPTION_FORMAT);

    private static final Component MARIO_UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(
            Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(Marioverse.MOD_ID, "smithing_template.mario_costume.additions_slot_description")));
    ...
    public static SmithingTemplateItem createMarioUpgradeTemplate() {
        return new SmithingTemplateItem(
                CHARACTER_UPGRADE_APPLIES_TO,
                MARIO_UPGRADE_INGREDIENTS,
                MARIO_UPGRADE,
                CHARACTER_UPGRADE_BASE_SLOT_DESCRIPTION,
                MARIO_UPGRADE_ADDITIONS_SLOT_DESCRIPTION,
