...
public class FireFlowerItem extends PowerUpItem implements PowerUpSource {

    public FireFlowerItem(Properties properties) {
        super(properties);
    }

    public FireFlowerItem(int tooltipLineAmt, Properties properties) {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (player instanceof AbilitiesHandler handler) {
            handler.applyFireFlowerPowerUp(level, player, this);
