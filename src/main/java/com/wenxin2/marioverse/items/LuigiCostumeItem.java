...
import com.wenxin2.marioverse.client.renderers.costumes.LuigiCostumeRenderer;
...
public class LuigiCostumeItem extends BaseCostumeItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public LuigiCostumeItem(Holder<ArmorMaterial> armorMaterial, Type armorType, Properties properties) {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> HumanoidModel<?> getGeoArmorRenderer(@Nullable T livingEntity,
                ...
                if(this.renderer == null)
                    this.renderer = new LuigiCostumeRenderer();
