...
public class MarioverseCreativeTabs {
    ...
    public static void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == MARIOVERSE_ITEMS_TAB.getKey() && !ConfigRegistry.DISABLE_MARIOVERSE_TABS.get()) {
            ...
            add(event, ItemRegistry.MARIO_PANTS.get());
            add(event, ItemRegistry.MARIO_SHOES.get());
            add(event, ItemRegistry.MARIO_FIRE_HAT.get());
        ...
        if (event.getTabKey() == MARIOVERSE_BLOCKS_TAB.getKey() && !ConfigRegistry.DISABLE_MARIOVERSE_TABS.get()) {
            ...
            add(event, BlockRegistry.AMETHYST_QUESTION_BLOCK.get());
            add(event, BlockRegistry.STONE_QUESTION_BRICKS.get());
            add(event, BlockRegistry.MOSSY_STONE_QUESTION_BRICKS.get());
            add(event, BlockRegistry.DEEPSLATE_QUESTION_BRICKS.get());
            add(event, BlockRegistry.DEEPSLATE_QUESTION_TILES.get());
            add(event, BlockRegistry.TUFF_QUESTION_BRICKS.get());
            add(event, BlockRegistry.QUESTION_BRICKS.get());
            add(event, BlockRegistry.MUD_QUESTION_BRICKS.get());
            add(event, BlockRegistry.SANDSTONE_QUESTION_BLOCK.get());
            add(event, BlockRegistry.RED_SANDSTONE_QUESTION_BLOCK.get());
            add(event, BlockRegistry.PRISMARINE_QUESTION_BRICKS.get());
            add(event, BlockRegistry.DARK_PRISMARINE_QUESTION_BLOCK.get());
            ...
            add(event, BlockRegistry.COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.EXPOSED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.WEATHERED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.OXIDIZED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.WAXED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.WAXED_EXPOSED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.WAXED_WEATHERED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.WAXED_OXIDIZED_COPPER_QUESTION_BLOCK.get());

            add(event, BlockRegistry.INVISIBLE_FUNGAL_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_DEEP_FUNGAL_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_AMETHYST_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_STONE_QUESTION_BRICKS.get());
            add(event, BlockRegistry.INVISIBLE_MOSSY_STONE_QUESTION_BRICKS.get());
            add(event, BlockRegistry.INVISIBLE_DEEPSLATE_QUESTION_BRICKS.get());
            add(event, BlockRegistry.INVISIBLE_DEEPSLATE_QUESTION_TILES.get());
            add(event, BlockRegistry.INVISIBLE_TUFF_QUESTION_BRICKS.get());
            add(event, BlockRegistry.INVISIBLE_QUESTION_BRICKS.get());
            add(event, BlockRegistry.INVISIBLE_MUD_QUESTION_BRICKS.get());
            add(event, BlockRegistry.INVISIBLE_SANDSTONE_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_RED_SANDSTONE_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_PRISMARINE_QUESTION_BRICKS.get());
            add(event, BlockRegistry.INVISIBLE_DARK_PRISMARINE_QUESTION_BLOCK.get());
            ...
            add(event, BlockRegistry.INVISIBLE_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_EXPOSED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_WEATHERED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_OXIDIZED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_WAXED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_WAXED_EXPOSED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_WAXED_WEATHERED_COPPER_QUESTION_BLOCK.get());
            add(event, BlockRegistry.INVISIBLE_WAXED_OXIDIZED_COPPER_QUESTION_BLOCK.get());

            add(event, BlockRegistry.STORAGE_FUNGAL_BRICKS.get());
            add(event, BlockRegistry.STORAGE_DEEP_FUNGAL_BRICKS.get());
            add(event, BlockRegistry.STORAGE_AMETHYST_BRICKS.get());
            add(event, BlockRegistry.STORAGE_STONE_BRICKS.get());
            add(event, BlockRegistry.STORAGE_MOSSY_STONE_BRICKS.get());
            add(event, BlockRegistry.STORAGE_DEEPSLATE_BRICKS.get());
            add(event, BlockRegistry.STORAGE_DEEPSLATE_TILES.get());
            add(event, BlockRegistry.STORAGE_TUFF_BRICKS.get());
            add(event, BlockRegistry.STORAGE_BRICKS.get());
            add(event, BlockRegistry.STORAGE_MUD_BRICKS.get());
            add(event, BlockRegistry.STORAGE_SANDSTONE_BRICKS.get());
            add(event, BlockRegistry.STORAGE_RED_SANDSTONE_BRICKS.get());
            add(event, BlockRegistry.STORAGE_PRISMARINE_BRICKS.get());
            add(event, BlockRegistry.STORAGE_DARK_PRISMARINE.get());
            ...
            add(event, BlockRegistry.STORAGE_CUT_COPPER.get());
            add(event, BlockRegistry.STORAGE_EXPOSED_CUT_COPPER.get());
            add(event, BlockRegistry.STORAGE_WEATHERED_CUT_COPPER.get());
            add(event, BlockRegistry.STORAGE_OXIDIZED_CUT_COPPER.get());
            add(event, BlockRegistry.STORAGE_WAXED_CUT_COPPER.get());
            add(event, BlockRegistry.STORAGE_WAXED_EXPOSED_CUT_COPPER.get());
            add(event, BlockRegistry.STORAGE_WAXED_WEATHERED_CUT_COPPER.get());
            add(event, BlockRegistry.STORAGE_WAXED_OXIDIZED_CUT_COPPER.get());

            add(event, BlockRegistry.SMASHABLE_STONE_BRICKS.get());
            add(event, BlockRegistry.SMASHABLE_MOSSY_STONE_BRICKS.get());
            add(event, BlockRegistry.SMASHABLE_DEEPSLATE_BRICKS.get());
            add(event, BlockRegistry.SMASHABLE_DEEPSLATE_TILES.get());
            add(event, BlockRegistry.SMASHABLE_TUFF_BRICKS.get());
            add(event, BlockRegistry.SMASHABLE_BRICKS.get());
            add(event, BlockRegistry.SMASHABLE_MUD_BRICKS.get());
            add(event, BlockRegistry.SMASHABLE_PRISMARINE_BRICKS.get());
            add(event, BlockRegistry.SMASHABLE_DARK_PRISMARINE.get());
            ...
            add(event, BlockRegistry.SMASHABLE_CUT_COPPER.get());
            add(event, BlockRegistry.SMASHABLE_EXPOSED_CUT_COPPER.get());
            add(event, BlockRegistry.SMASHABLE_WEATHERED_CUT_COPPER.get());
            add(event, BlockRegistry.SMASHABLE_OXIDIZED_CUT_COPPER.get());
            add(event, BlockRegistry.SMASHABLE_WAXED_CUT_COPPER.get());
            add(event, BlockRegistry.SMASHABLE_WAXED_EXPOSED_CUT_COPPER.get());
            add(event, BlockRegistry.SMASHABLE_WAXED_WEATHERED_CUT_COPPER.get());
            add(event, BlockRegistry.SMASHABLE_WAXED_OXIDIZED_CUT_COPPER.get());
            ...
            add(event, BlockRegistry.MOSSY_STONE_BRICK_PEDESTAL.get());
            add(event, BlockRegistry.DEEPSLATE_BRICK_PEDESTAL.get());
            add(event, BlockRegistry.DEEPSLATE_TILE_PEDESTAL.get());
            add(event, BlockRegistry.TUFF_BRICK_PEDESTAL.get());
            add(event, BlockRegistry.BRICK_PEDESTAL.get());
            add(event, BlockRegistry.MUD_BRICK_PEDESTAL.get());
            add(event, BlockRegistry.SANDSTONE_BRICK_PEDESTAL.get());
            add(event, BlockRegistry.RED_SANDSTONE_BRICK_PEDESTAL.get());
            add(event, BlockRegistry.PRISMARINE_BRICK_PEDESTAL.get());
            add(event, BlockRegistry.DARK_PRISMARINE_PEDESTAL.get());
            ...
            add(event, BlockRegistry.CUT_COPPER_PEDESTAL.get());
            add(event, BlockRegistry.EXPOSED_CUT_COPPER_PEDESTAL.get());
            add(event, BlockRegistry.WEATHERED_CUT_COPPER_PEDESTAL.get());
            add(event, BlockRegistry.OXIDIZED_CUT_COPPER_PEDESTAL.get());
            add(event, BlockRegistry.WAXED_CUT_COPPER_PEDESTAL.get());
            add(event, BlockRegistry.WAXED_EXPOSED_CUT_COPPER_PEDESTAL.get());
            add(event, BlockRegistry.WAXED_WEATHERED_CUT_COPPER_PEDESTAL.get());
            add(event, BlockRegistry.WAXED_OXIDIZED_CUT_COPPER_PEDESTAL.get());
            ...
            add(event, BlockRegistry.CHISELED_FUNGAL_BRICKS.get());

            add(event, BlockRegistry.DEEP_FUNGAL_STONE.get());
            add(event, BlockRegistry.DEEP_FUNGAL_STONE_STAIRS.get());
            add(event, BlockRegistry.DEEP_FUNGAL_STONE_SLAB.get());
            add(event, BlockRegistry.DEEP_FUNGAL_STONE_WALL.get());
            add(event, BlockRegistry.DEEP_FUNGAL_STONE_PRESSURE_PLATE.get());
            add(event, BlockRegistry.DEEP_FUNGAL_STONE_BUTTON.get());

            add(event, BlockRegistry.POLISHED_DEEP_FUNGAL_STONE.get());
            ...
            add(event, BlockRegistry.CHISELED_DEEP_FUNGAL_BRICKS.get());

            add(event, Blocks.AMETHYST_BLOCK);
            add(event, BlockRegistry.AMETHYST_STAIRS.get());
            add(event, BlockRegistry.AMETHYST_SLAB.get());
            add(event, BlockRegistry.AMETHYST_WALL.get());
            ...
            add(event, BlockRegistry.SANDSTONE_BRICKS.get());
            add(event, BlockRegistry.CRACKED_SANDSTONE_BRICKS.get());
            add(event, BlockRegistry.SANDSTONE_BRICK_STAIRS.get());
            add(event, BlockRegistry.SANDSTONE_BRICK_SLAB.get());
            add(event, BlockRegistry.SANDSTONE_BRICK_WALL.get());
            add(event, BlockRegistry.CHISELED_SANDSTONE_BRICKS.get());

            add(event, Blocks.RED_SANDSTONE);
            add(event, Blocks.CUT_RED_SANDSTONE);
            add(event, Blocks.CHISELED_RED_SANDSTONE);
            add(event, BlockRegistry.RED_SANDSTONE_BRICKS.get());
            add(event, BlockRegistry.CRACKED_RED_SANDSTONE_BRICKS.get());
            add(event, BlockRegistry.RED_SANDSTONE_BRICK_STAIRS.get());
            add(event, BlockRegistry.RED_SANDSTONE_BRICK_SLAB.get());
            add(event, BlockRegistry.RED_SANDSTONE_BRICK_WALL.get());
            add(event, BlockRegistry.CHISELED_RED_SANDSTONE_BRICKS.get());
        }

        if (!ConfigRegistry.DISABLE_VANILLA_TABS.get()) {
            if (event.getTabKey() == CreativeModeTabs.NATURAL_BLOCKS) {
                addAfter(event, Blocks.PRISMARINE, BlockRegistry.FUNGAL_STONE.get());
                addAfter(event, BlockRegistry.FUNGAL_STONE.get(), BlockRegistry.DEEP_FUNGAL_STONE.get());
            }
            ...
            if (event.getTabKey() == CreativeModeTabs.REDSTONE_BLOCKS) {
                ...
                addAfter(event, BlockRegistry.FUNGAL_STONE_BUTTON.get(), BlockRegistry.DEEP_FUNGAL_STONE_BUTTON.get());
                addAfter(event, BlockRegistry.DEEP_FUNGAL_STONE_BUTTON.get(), BlockRegistry.AMETHYST_BUTTON.get());

                addAfter(event, Blocks.STONE_PRESSURE_PLATE, BlockRegistry.FUNGAL_STONE_PRESSURE_PLATE.get());
                addAfter(event, BlockRegistry.FUNGAL_STONE_PRESSURE_PLATE.get(), BlockRegistry.DEEP_FUNGAL_STONE_PRESSURE_PLATE.get());
                addAfter(event, BlockRegistry.DEEP_FUNGAL_STONE_PRESSURE_PLATE.get(), BlockRegistry.AMETHYST_PRESSURE_PLATE.get());
            ...
            if (event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS) {
                ...
                addAfter(event, BlockRegistry.FUNGAL_STONE_WALL.get(), BlockRegistry.FUNGAL_STONE_PRESSURE_PLATE.get());
                ...
                addAfter(event, BlockRegistry.DEEP_FUNGAL_STONE.get(), BlockRegistry.DEEP_FUNGAL_STONE_STAIRS.get());
                addAfter(event, BlockRegistry.DEEP_FUNGAL_STONE_STAIRS.get(), BlockRegistry.DEEP_FUNGAL_STONE_SLAB.get());
                addAfter(event, BlockRegistry.DEEP_FUNGAL_STONE_SLAB.get(), BlockRegistry.DEEP_FUNGAL_STONE_WALL.get());
                addAfter(event, BlockRegistry.DEEP_FUNGAL_STONE_WALL.get(), BlockRegistry.DEEP_FUNGAL_STONE_PRESSURE_PLATE.get());
                addAfter(event, BlockRegistry.DEEP_FUNGAL_STONE_PRESSURE_PLATE.get(), BlockRegistry.DEEP_FUNGAL_STONE_BUTTON.get());

                addAfter(event, BlockRegistry.DEEP_FUNGAL_STONE_BUTTON.get(), BlockRegistry.POLISHED_DEEP_FUNGAL_STONE.get());
                addAfter(event, BlockRegistry.POLISHED_DEEP_FUNGAL_STONE.get(), BlockRegistry.POLISHED_DEEP_FUNGAL_STONE_STAIRS.get());
                addAfter(event, BlockRegistry.POLISHED_DEEP_FUNGAL_STONE_STAIRS.get(), BlockRegistry.POLISHED_DEEP_FUNGAL_STONE_SLAB.get());
                addAfter(event, BlockRegistry.POLISHED_DEEP_FUNGAL_STONE_SLAB.get(), BlockRegistry.POLISHED_DEEP_FUNGAL_STONE_WALL.get());

                addAfter(event, Blocks.STONE_BRICK_WALL, BlockRegistry.STONE_BRICK_PEDESTAL.get());
                addAfter(event, Blocks.CHISELED_STONE_BRICKS, BlockRegistry.SMASHABLE_STONE_BRICKS.get());

                addAfter(event, Blocks.MOSSY_STONE_BRICK_WALL, BlockRegistry.MOSSY_STONE_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.MOSSY_STONE_BRICK_PEDESTAL.get(), BlockRegistry.SMASHABLE_MOSSY_STONE_BRICKS.get());

                addAfter(event, Blocks.DEEPSLATE_BRICK_WALL, BlockRegistry.DEEPSLATE_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.DEEPSLATE_BRICK_PEDESTAL.get(), BlockRegistry.SMASHABLE_DEEPSLATE_BRICKS.get());
                addAfter(event, Blocks.DEEPSLATE_TILE_WALL, BlockRegistry.DEEPSLATE_TILE_PEDESTAL.get());
                addAfter(event, BlockRegistry.DEEPSLATE_TILE_PEDESTAL.get(), BlockRegistry.SMASHABLE_DEEPSLATE_TILES.get());

                addAfter(event, Blocks.TUFF_BRICK_WALL, BlockRegistry.TUFF_BRICK_PEDESTAL.get());
                addAfter(event, Blocks.CHISELED_TUFF_BRICKS, BlockRegistry.SMASHABLE_TUFF_BRICKS.get());
                ...
                addAfter(event, Blocks.CUT_SANDSTONE_SLAB, BlockRegistry.SANDSTONE_BRICKS.get());
                addAfter(event, BlockRegistry.SANDSTONE_BRICKS.get(), BlockRegistry.CRACKED_SANDSTONE_BRICKS.get());
                addAfter(event, BlockRegistry.CRACKED_SANDSTONE_BRICKS.get(), BlockRegistry.SANDSTONE_BRICK_STAIRS.get());
                addAfter(event, BlockRegistry.SANDSTONE_BRICK_STAIRS.get(), BlockRegistry.SANDSTONE_BRICK_SLAB.get());
                addAfter(event, BlockRegistry.SANDSTONE_BRICK_SLAB.get(), BlockRegistry.SANDSTONE_BRICK_WALL.get());
                addAfter(event, BlockRegistry.SANDSTONE_BRICK_WALL.get(), BlockRegistry.SANDSTONE_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.SANDSTONE_BRICK_PEDESTAL.get(), BlockRegistry.CHISELED_SANDSTONE_BRICKS.get());

                addAfter(event, Blocks.CUT_RED_SANDSTONE_SLAB, BlockRegistry.RED_SANDSTONE_BRICKS.get());
                addAfter(event, BlockRegistry.RED_SANDSTONE_BRICKS.get(), BlockRegistry.CRACKED_RED_SANDSTONE_BRICKS.get());
                addAfter(event, BlockRegistry.CRACKED_RED_SANDSTONE_BRICKS.get(), BlockRegistry.RED_SANDSTONE_BRICK_STAIRS.get());
                addAfter(event, BlockRegistry.RED_SANDSTONE_BRICK_STAIRS.get(), BlockRegistry.RED_SANDSTONE_BRICK_SLAB.get());
                addAfter(event, BlockRegistry.RED_SANDSTONE_BRICK_SLAB.get(), BlockRegistry.RED_SANDSTONE_BRICK_WALL.get());
                addAfter(event, BlockRegistry.RED_SANDSTONE_BRICK_WALL.get(), BlockRegistry.RED_SANDSTONE_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.RED_SANDSTONE_BRICK_PEDESTAL.get(), BlockRegistry.CHISELED_RED_SANDSTONE_BRICKS.get());

                addAfter(event, Blocks.PRISMARINE_BRICK_SLAB, BlockRegistry.PRISMARINE_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.PRISMARINE_BRICK_PEDESTAL.get(), BlockRegistry.SMASHABLE_PRISMARINE_BRICKS.get());

                addAfter(event, Blocks.DARK_PRISMARINE_SLAB, BlockRegistry.DARK_PRISMARINE_PEDESTAL.get());
                addAfter(event, BlockRegistry.DARK_PRISMARINE_PEDESTAL.get(), BlockRegistry.SMASHABLE_DARK_PRISMARINE.get());

                addAfter(event, Blocks.AMETHYST_BLOCK, BlockRegistry.AMETHYST_STAIRS.get());
                addAfter(event, BlockRegistry.AMETHYST_STAIRS.get(), BlockRegistry.AMETHYST_SLAB.get());
                addAfter(event, BlockRegistry.AMETHYST_SLAB.get(), BlockRegistry.AMETHYST_WALL.get());
                ...
                addAfter(event, BlockRegistry.AMETHYST_BRICK_WALL.get(), BlockRegistry.AMETHYST_BRICK_PEDESTAL.get());
                ...
                addAfter(event, BlockRegistry.DEEP_FUNGAL_BRICK_PEDESTAL.get(), BlockRegistry.CHISELED_DEEP_FUNGAL_BRICKS.get());
                ...
                addAfter(event, Blocks.POLISHED_BLACKSTONE_BRICK_WALL, BlockRegistry.BLACKSTONE_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.BLACKSTONE_BRICK_PEDESTAL.get(), BlockRegistry.SMASHABLE_BLACKSTONE_BRICKS.get());
                ...
                addAfter(event, Blocks.CUT_COPPER_SLAB, BlockRegistry.CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.CUT_COPPER_PEDESTAL.get(), BlockRegistry.SMASHABLE_CUT_COPPER.get());

                addAfter(event, Blocks.EXPOSED_CUT_COPPER_SLAB, BlockRegistry.EXPOSED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.EXPOSED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.SMASHABLE_EXPOSED_CUT_COPPER.get());

                addAfter(event, Blocks.WEATHERED_CUT_COPPER_SLAB, BlockRegistry.WEATHERED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.WEATHERED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.SMASHABLE_WEATHERED_CUT_COPPER.get());

                addAfter(event, Blocks.OXIDIZED_CUT_COPPER_SLAB, BlockRegistry.OXIDIZED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.OXIDIZED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.SMASHABLE_OXIDIZED_CUT_COPPER.get());

                addAfter(event, Blocks.WAXED_CUT_COPPER_SLAB, BlockRegistry.WAXED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.WAXED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.SMASHABLE_WAXED_CUT_COPPER.get());

                addAfter(event, Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, BlockRegistry.WAXED_EXPOSED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.WAXED_EXPOSED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.SMASHABLE_WAXED_EXPOSED_CUT_COPPER.get());

                addAfter(event, Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, BlockRegistry.WAXED_WEATHERED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.WAXED_WEATHERED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.SMASHABLE_WAXED_WEATHERED_CUT_COPPER.get());

                addAfter(event, Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, BlockRegistry.WAXED_OXIDIZED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.WAXED_OXIDIZED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.SMASHABLE_WAXED_OXIDIZED_CUT_COPPER.get());
            }

            if (event.getTabKey() == CreativeModeTabs.FUNCTIONAL_BLOCKS) {
                addBefore(event, Items.LIGHTNING_ROD, BlockRegistry.FUNGAL_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.FUNGAL_QUESTION_BLOCK.get(), BlockRegistry.DEEP_FUNGAL_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.DEEP_FUNGAL_QUESTION_BLOCK.get(), BlockRegistry.AMETHYST_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.AMETHYST_QUESTION_BLOCK.get(), BlockRegistry.STONE_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.STONE_QUESTION_BRICKS.get(), BlockRegistry.MOSSY_STONE_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.MOSSY_STONE_QUESTION_BRICKS.get(), BlockRegistry.DEEPSLATE_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.DEEPSLATE_QUESTION_BRICKS.get(), BlockRegistry.DEEPSLATE_QUESTION_TILES.get());
                addAfter(event, BlockRegistry.DEEPSLATE_QUESTION_TILES.get(), BlockRegistry.TUFF_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.TUFF_QUESTION_BRICKS.get(), BlockRegistry.QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.QUESTION_BRICKS.get(), BlockRegistry.MUD_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.MUD_QUESTION_BRICKS.get(), BlockRegistry.SANDSTONE_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.SANDSTONE_QUESTION_BLOCK.get(), BlockRegistry.RED_SANDSTONE_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.RED_SANDSTONE_QUESTION_BLOCK.get(), BlockRegistry.PRISMARINE_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.PRISMARINE_QUESTION_BRICKS.get(), BlockRegistry.NETHER_QUESTION_BRICKS.get());
                ...
                addAfter(event, BlockRegistry.PURPUR_QUESTION_BLOCK.get(), BlockRegistry.COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.COPPER_QUESTION_BLOCK.get(), BlockRegistry.EXPOSED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.EXPOSED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.WEATHERED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.WEATHERED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.OXIDIZED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.OXIDIZED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.WAXED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.WAXED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.WAXED_EXPOSED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.WAXED_EXPOSED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.WAXED_WEATHERED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.WAXED_WEATHERED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.WAXED_OXIDIZED_COPPER_QUESTION_BLOCK.get());

                addAfter(event, BlockRegistry.WAXED_OXIDIZED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_FUNGAL_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_FUNGAL_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_DEEP_FUNGAL_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_DEEP_FUNGAL_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_AMETHYST_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_AMETHYST_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_STONE_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.INVISIBLE_STONE_QUESTION_BRICKS.get(), BlockRegistry.INVISIBLE_MOSSY_STONE_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.INVISIBLE_MOSSY_STONE_QUESTION_BRICKS.get(), BlockRegistry.INVISIBLE_DEEPSLATE_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.INVISIBLE_DEEPSLATE_QUESTION_BRICKS.get(), BlockRegistry.INVISIBLE_DEEPSLATE_QUESTION_TILES.get());
                addAfter(event, BlockRegistry.INVISIBLE_DEEPSLATE_QUESTION_TILES.get(), BlockRegistry.INVISIBLE_TUFF_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.INVISIBLE_TUFF_QUESTION_BRICKS.get(), BlockRegistry.INVISIBLE_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.INVISIBLE_QUESTION_BRICKS.get(), BlockRegistry.INVISIBLE_MUD_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.INVISIBLE_MUD_QUESTION_BRICKS.get(), BlockRegistry.INVISIBLE_SANDSTONE_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_SANDSTONE_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_RED_SANDSTONE_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_RED_SANDSTONE_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_PRISMARINE_QUESTION_BRICKS.get());
                addAfter(event, BlockRegistry.INVISIBLE_PRISMARINE_QUESTION_BRICKS.get(), BlockRegistry.INVISIBLE_DARK_PRISMARINE_QUESTION_BLOCK.get());
                ...
                addAfter(event, BlockRegistry.INVISIBLE_PURPUR_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_COPPER_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_EXPOSED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_EXPOSED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_WEATHERED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_WEATHERED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_OXIDIZED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_OXIDIZED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_WAXED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_WAXED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_WAXED_EXPOSED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_WAXED_EXPOSED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_WAXED_WEATHERED_COPPER_QUESTION_BLOCK.get());
                addAfter(event, BlockRegistry.INVISIBLE_WAXED_WEATHERED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.INVISIBLE_WAXED_OXIDIZED_COPPER_QUESTION_BLOCK.get());

                addAfter(event, BlockRegistry.INVISIBLE_WAXED_OXIDIZED_COPPER_QUESTION_BLOCK.get(), BlockRegistry.STORAGE_FUNGAL_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_FUNGAL_BRICKS.get(), BlockRegistry.STORAGE_DEEP_FUNGAL_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_DEEP_FUNGAL_BRICKS.get(), BlockRegistry.STORAGE_AMETHYST_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_AMETHYST_BRICKS.get(), BlockRegistry.STORAGE_STONE_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_STONE_BRICKS.get(), BlockRegistry.STORAGE_MOSSY_STONE_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_MOSSY_STONE_BRICKS.get(), BlockRegistry.STORAGE_DEEPSLATE_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_DEEPSLATE_BRICKS.get(), BlockRegistry.STORAGE_DEEPSLATE_TILES.get());
                addAfter(event, BlockRegistry.STORAGE_DEEPSLATE_TILES.get(), BlockRegistry.STORAGE_TUFF_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_TUFF_BRICKS.get(), BlockRegistry.STORAGE_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_BRICKS.get(), BlockRegistry.STORAGE_MUD_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_MUD_BRICKS.get(), BlockRegistry.STORAGE_SANDSTONE_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_SANDSTONE_BRICKS.get(), BlockRegistry.STORAGE_RED_SANDSTONE_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_RED_SANDSTONE_BRICKS.get(), BlockRegistry.STORAGE_PRISMARINE_BRICKS.get());
                addAfter(event, BlockRegistry.STORAGE_PRISMARINE_BRICKS.get(), BlockRegistry.STORAGE_DARK_PRISMARINE.get());
                ...
                addAfter(event, BlockRegistry.STORAGE_PURPUR_BLOCK.get(), BlockRegistry.STORAGE_CUT_COPPER.get());
                addAfter(event, BlockRegistry.STORAGE_CUT_COPPER.get(), BlockRegistry.STORAGE_EXPOSED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.STORAGE_EXPOSED_CUT_COPPER.get(), BlockRegistry.STORAGE_WEATHERED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.STORAGE_WEATHERED_CUT_COPPER.get(), BlockRegistry.STORAGE_OXIDIZED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.STORAGE_OXIDIZED_CUT_COPPER.get(), BlockRegistry.STORAGE_WAXED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.STORAGE_WAXED_CUT_COPPER.get(), BlockRegistry.STORAGE_WAXED_EXPOSED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.STORAGE_WAXED_EXPOSED_CUT_COPPER.get(), BlockRegistry.STORAGE_WAXED_WEATHERED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.STORAGE_WAXED_WEATHERED_CUT_COPPER.get(), BlockRegistry.STORAGE_WAXED_OXIDIZED_CUT_COPPER.get());

                addAfter(event, BlockRegistry.STORAGE_WAXED_OXIDIZED_CUT_COPPER.get(), BlockRegistry.FUNGAL_BRICKS.get());
                addAfter(event, BlockRegistry.FUNGAL_BRICKS.get(), BlockRegistry.DEEP_FUNGAL_BRICKS.get());
                addAfter(event, BlockRegistry.DEEP_FUNGAL_BRICKS.get(), BlockRegistry.AMETHYST_BRICKS.get());
                addAfter(event, BlockRegistry.AMETHYST_BRICKS.get(), BlockRegistry.SMASHABLE_STONE_BRICKS.get());
                addAfter(event, BlockRegistry.SMASHABLE_STONE_BRICKS.get(), BlockRegistry.SMASHABLE_MOSSY_STONE_BRICKS.get());
                addAfter(event, BlockRegistry.SMASHABLE_MOSSY_STONE_BRICKS.get(), BlockRegistry.SMASHABLE_DEEPSLATE_BRICKS.get());
                addAfter(event, BlockRegistry.SMASHABLE_DEEPSLATE_BRICKS.get(), BlockRegistry.SMASHABLE_DEEPSLATE_TILES.get());
                addAfter(event, BlockRegistry.SMASHABLE_DEEPSLATE_TILES.get(), BlockRegistry.SMASHABLE_TUFF_BRICKS.get());
                addAfter(event, BlockRegistry.SMASHABLE_TUFF_BRICKS.get(), BlockRegistry.SMASHABLE_BRICKS.get());
                addAfter(event, BlockRegistry.SMASHABLE_BRICKS.get(), BlockRegistry.SMASHABLE_MUD_BRICKS.get());
                addAfter(event, BlockRegistry.SMASHABLE_MUD_BRICKS.get(), BlockRegistry.CRACKED_SANDSTONE_BRICKS.get());
                addAfter(event, BlockRegistry.CRACKED_SANDSTONE_BRICKS.get(), BlockRegistry.CRACKED_RED_SANDSTONE_BRICKS.get());
                addAfter(event, BlockRegistry.CRACKED_RED_SANDSTONE_BRICKS.get(), BlockRegistry.SMASHABLE_PRISMARINE_BRICKS.get());
                addAfter(event, BlockRegistry.SMASHABLE_PRISMARINE_BRICKS.get(), BlockRegistry.SMASHABLE_DARK_PRISMARINE.get());
                ...
                addAfter(event, BlockRegistry.SMASHABLE_PURPUR_BLOCK.get(), BlockRegistry.SMASHABLE_CUT_COPPER.get());
                addAfter(event, BlockRegistry.SMASHABLE_CUT_COPPER.get(), BlockRegistry.SMASHABLE_EXPOSED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.SMASHABLE_EXPOSED_CUT_COPPER.get(), BlockRegistry.SMASHABLE_WEATHERED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.SMASHABLE_WEATHERED_CUT_COPPER.get(), BlockRegistry.SMASHABLE_OXIDIZED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.SMASHABLE_OXIDIZED_CUT_COPPER.get(), BlockRegistry.SMASHABLE_WAXED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.SMASHABLE_WAXED_CUT_COPPER.get(), BlockRegistry.SMASHABLE_WAXED_EXPOSED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.SMASHABLE_WAXED_EXPOSED_CUT_COPPER.get(), BlockRegistry.SMASHABLE_WAXED_WEATHERED_CUT_COPPER.get());
                addAfter(event, BlockRegistry.SMASHABLE_WAXED_WEATHERED_CUT_COPPER.get(), BlockRegistry.SMASHABLE_WAXED_OXIDIZED_CUT_COPPER.get());

                addAfter(event, BlockRegistry.SMASHABLE_WAXED_OXIDIZED_CUT_COPPER.get(), BlockRegistry.FUNGAL_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.FUNGAL_BRICK_PEDESTAL.get(), BlockRegistry.DEEP_FUNGAL_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.DEEP_FUNGAL_BRICK_PEDESTAL.get(), BlockRegistry.AMETHYST_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.AMETHYST_BRICK_PEDESTAL.get(), BlockRegistry.STONE_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.STONE_BRICK_PEDESTAL.get(), BlockRegistry.MOSSY_STONE_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.MOSSY_STONE_BRICK_PEDESTAL.get(), BlockRegistry.DEEPSLATE_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.DEEPSLATE_BRICK_PEDESTAL.get(), BlockRegistry.DEEPSLATE_TILE_PEDESTAL.get());
                addAfter(event, BlockRegistry.DEEPSLATE_TILE_PEDESTAL.get(), BlockRegistry.TUFF_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.TUFF_BRICK_PEDESTAL.get(), BlockRegistry.BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.BRICK_PEDESTAL.get(), BlockRegistry.MUD_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.MUD_BRICK_PEDESTAL.get(), BlockRegistry.PRISMARINE_BRICK_PEDESTAL.get());
                addAfter(event, BlockRegistry.PRISMARINE_BRICK_PEDESTAL.get(), BlockRegistry.DARK_PRISMARINE_PEDESTAL.get());
                ...
                addAfter(event, BlockRegistry.PURPUR_BLOCK_PEDESTAL.get(), BlockRegistry.CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.CUT_COPPER_PEDESTAL.get(), BlockRegistry.EXPOSED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.EXPOSED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.WEATHERED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.WEATHERED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.OXIDIZED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.OXIDIZED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.WAXED_EXPOSED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.WAXED_EXPOSED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.WAXED_WEATHERED_CUT_COPPER_PEDESTAL.get());
                addAfter(event, BlockRegistry.WAXED_WEATHERED_CUT_COPPER_PEDESTAL.get(), BlockRegistry.WAXED_OXIDIZED_CUT_COPPER_PEDESTAL.get());
