...
import com.wenxin2.marioverse.network.server_bound.handler.DoubleJumpPacket;
import com.wenxin2.marioverse.network.server_bound.handler.FacingDirectionPacket;
...
import com.wenxin2.marioverse.network.server_bound.handler.IsSneakingPacket;
...
public class PacketHandler {
    ...
    public static void registerPackets(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(DoubleJumpPayload.PAYLOAD, DoubleJumpPayload.STREAM_CODEC, DoubleJumpPacket.get()::handle);
        ...
        registrar.playToServer(IsSneakingPayload.PAYLOAD, IsSneakingPayload.STREAM_CODEC, IsSneakingPacket.get()::handle);
