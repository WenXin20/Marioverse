...
public class PlacementDirectionPacket {
    public static final PlacementDirectionPacket INSTANCE = new PlacementDirectionPacket();

    public static PlacementDirectionPacket get() {
        return INSTANCE;
    }

    public void handle(final PlacementDirectionPayload payload, IPayloadContext context) {
                ...
                if (player.containerMenu.containerId == payload.containerId()
                    ...
                    menu.getAccess().execute((level, pos) -> {
                        ...
                        if (blockEntity instanceof BlockSpawnerBlockEntity spawnerBE) {
                            ...
                            spawnerBE.setPlacementDirection(payload.placementDirection());
