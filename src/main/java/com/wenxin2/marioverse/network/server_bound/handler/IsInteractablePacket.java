...
public class IsInteractablePacket {
    public static final IsInteractablePacket INSTANCE = new IsInteractablePacket();

    public static IsInteractablePacket get() {
        return INSTANCE;
    }

    public void handle(final IsInteractablePayload payload, IPayloadContext context) {
                ...
                if (player.containerMenu.containerId == payload.containerId()
                    ...
                    menu.getAccess().execute((level, pos) -> {
                        ...
                        if (blockEntity instanceof BlockSpawnerBlockEntity spawnerBE) {
                            spawnerBE.setInteractable(payload.isInteractable());
