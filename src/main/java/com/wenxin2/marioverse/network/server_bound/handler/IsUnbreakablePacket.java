...
public class IsUnbreakablePacket {
    public static final IsUnbreakablePacket INSTANCE = new IsUnbreakablePacket();

    public static IsUnbreakablePacket get() {
        return INSTANCE;
    }

    public void handle(final IsUnbreakablePayload payload, IPayloadContext context) {
                ...
                if (player.containerMenu.containerId == payload.containerId()
                    ...
                    menu.getAccess().execute((level, pos) -> {
                        ...
                        if (blockEntity instanceof BlockSpawnerBlockEntity spawnerBE) {
                            spawnerBE.setUnbreakable(payload.isUnbreakable());
