...
public class FacingDirectionPacket {
    public static final FacingDirectionPacket INSTANCE = new FacingDirectionPacket();

    public static FacingDirectionPacket get() {
        return INSTANCE;
    }

    public void handle(final FacingDirectionPayload payload, IPayloadContext context) {
                ...
                if (player.containerMenu.containerId == payload.containerId()
                    ...
                    menu.getAccess().execute((level, pos) -> {
                        ...
                        if (blockEntity instanceof BlockSpawnerBlockEntity spawnerBE) {
                            ...
                            spawnerBE.setFacingDirection(payload.facingDirection());
